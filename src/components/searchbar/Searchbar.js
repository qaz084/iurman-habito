  ...
  return (
    <>
      <div className="flex relative w-3/4 max-w-2/4 sm:w-2/4 md:w-1/3 ">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="w-4 h-4 top-2 sm:w-6 sm:h-6 absolute right-3 sm:top-1 hidden peer-placeholder-shown:inline ">
