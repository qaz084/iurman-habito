...
{/* Secondary Images */}
      ...
      lg:order-2 lg:flex-col  lg:self-center lg:h-[95%] lg:overflow-hidden lg:space-x-0 lg:mt-0 lg:w-[7rem] lg:space-y-4 lg:py-4 ">    
        ...
        <img className="rounded-md  " src={ItemDetail.img2} alt={ItemDetail.name} />

        <img className="rounded-md" src={ItemDetail.img3} alt={ItemDetail.name} />

        <img className="rounded-md" src={ItemDetail.img4} alt={ItemDetail.name} />
...
{/* Main Image */}
      ...
      lg:order-3 lg:h-[95%] lg:flex lg:w-full">
       <img className="rounded-xl" src={ItemDetail.img1} alt={ItemDetail.name} />
      </div>
